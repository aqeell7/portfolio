...
export function ProjectCard({ project, index }: ProjectCardProps) {
    return (
        <motion.div
            ...
            className="group relative flex flex-col justify-between h-full bg-card rounded-2xl border border-border shadow-sm hover:shadow-md hover:border-primary/50 transition-all overflow-hidden"
        >
            <div>
            ...
            <div className="flex items-center gap-3 mt-auto p-6 pt-4 border-t border-border/50">
                {project.liveLink ? (
